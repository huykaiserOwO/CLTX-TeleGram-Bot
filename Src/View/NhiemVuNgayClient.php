    ...
    <main>
        ...
        <div class="row" style="margin-top: 30px;">
            ...
            <div class="bodyBox" style="text-align: center;">
                <h2>VUI LÒNG <a href="" style="text-decoration: none;color:#fef142;">ĐĂNG NHẬP</a> HOẶC <a href=""
                        style="text-decoration: none;color:#fef142;">ĐĂNG KÝ</a> ĐỂ
                    NHẬN THƯỞNG</h2>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td><button type="button" class="btn btn-secondary"
                                            style="padding: 0 10px;font-size:80%">Chưa Đạt</button></td>
                                </tr>
                                <tr>
                                    <td>1,000,000</td>
