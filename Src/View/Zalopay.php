                ...
                <div class="row">
                    <div class="headerBox">
                        <h1><i class="fa-solid fa-dice-five"></i>
                            <p style="line-height: 15px;">GAME ZALOPAY</p>
                        </h1>
                    </div>
                    <div class="ListGame">
...
socket.emit('BankingList', ['<?= $_SESSION['IdTelegram'] ?>', 'Zalopay']);
var ZalopayList = document.getElementById('ZalopayList');
socket.on('ZalopayList', (data) => {
    var Text = "";
    Text += `
            <tr>
