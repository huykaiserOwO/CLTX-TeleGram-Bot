            ...
            <div class="bodyBox">
                <div style="text-align: center;margin-top: 10px;">
                    <form method="post" id="formData" onsubmit="unreloadPage(event)">
                        <div class="mb-3">
                            <input type="text" class="form-control" placeholder="Nhập Giftcode" name="Giftcode"
                                id="Giftcode">
                        </div>
                        ...
                        <div style="text-align: center;">
                            <button class="sign__btn" type="submit" fdprocessedid="6npn4" id="submitBtn"><span
                                    style="color: whitesmoke;font-weight:600;">Nhận
                                    Thưởng</span></button>
                        </div>
                        <div style="text-align: center;margin-top: 30px;">
                            <div style="font-size: 80%;">
                                <h2><i>LƯU Ý: HỆ THỐNG TỰ ĐỘNG KHÓA/CHẶN CÁC TÀI KHOẢN LẠM DỤNG HOẶC SỬ
                                        DỤNG CLONE ĐỂ NHẬP CODE.</i></h2>
                            </div>
                            <div style="font-size: 80%;">
                                <h2><i>HỆ THỐNG LIÊN TỤC PHÁT CODE NGẪU NHIÊN - MIỄN PHÍ MỖI 10-15P TẠI <a href=""
                                            style="text-decoration: none;color:#fe5b09;">GROUP TELEGRAM</a></i></h2>
                            </div>
                        </div>
                    </form>
                </div>
...
var Giftcode = document.getElementById('Giftcode');
